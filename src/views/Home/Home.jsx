  ...
  return <div className="home_gd">
    ...
    <div className="boodyBox fxColumn">
      ...
      <div className="contentStyle">
        CryptStarter DAO is a decentralized reserve currency protocol based on the LOCKER token and aims at building a community-owned decentralized financial infrastructure for the crypto world.
      </div>
